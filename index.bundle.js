...
var _bagOfTricks = __webpack_require__(1);

var _bagOfTricks2 = _interopRequireDefault(_bagOfTricks);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function init() {
  document.getElementById('common-header').innerHTML = _bagOfTricks2.default.header;
  document.getElementById('common-footer').innerHTML = _bagOfTricks2.default.footer;
}
...
var Header = function Header(context) {
  return "<header>" + context.title + " and my name is Josh</header>";
};
